  ...
  return (
    <>
      <div className="relative bg-gradient-to-b from-black to-slate-800 text-slate-400 min-h-screen pb-8 ">
        ...
        <div className="fixed bottom-0 left-32 hidden xl:flex lg:flex gap-4 items-center justify-between flex-col-reverse ">
        ...
        <div className="fixed bottom-0 right-32 hidden xl:flex lg:flex gap-8 items-center justify-between flex-col-reverse ">
          <div className="h-24 w-[2px] bg-slate-400 " />
          <Link
            hrefLang="en"
