...
function Hero() {
  return (
    <div className="flex flex-col gap-6 mt-24" >
      <span className="text-cyan-400 font-handjet text-lg font-bold " >Hi, my name is</span>
      ...
      <p className="font-poppins max-w-[480px] " >
        As a software engineer specializing in frontend development, you focus
        ...
        aesthetically pleasing to facilitate user <span className="text-cyan-400 font-handjet font-bold text-lg" >interaction.</span>
      </p>
    </div>
  );
}
