      ...
      <div className="flex justify-between py-8 items-center">
        ...
        <div
          onClick={() => {
            ...
            if (listElement) {
              listElement.classList.toggle("translate-x-0");

              // prevent clicking on the window
